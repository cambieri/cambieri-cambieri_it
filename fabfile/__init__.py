...
config = {
    'live': {
        ...
        'django': {
            'site_name': 'cambieri-cambieri_it',
            'site_dir_name': 'cambieri-cambieri_it-live',
            'site_root': '/opt/django/sites/cambieri-cambieri_it-live/',
            'project_dir_name': 'cambieri_it',
            'project_root': '/opt/django/sites/cambieri-cambieri_it-live/cambieri_it/',
            'settings_module': 'cambieri_it.settings.live'
        },
        'virtualenv': {
            'path': '/opt/django/virtualenvs/cambieri-cambieri_it-live/',
            'requirements_file': '/opt/django/sites/cambieri-cambieri_it-live/requirements/requirements_live.txt',
        },
        'git': {
            'server_name': 'origin',
            'branch_name': 'live',
        ...
        'webserver': {
            'touch_file': '/opt/django/sites/cambieri-cambieri_it-live/uwsgi/live/django_wsgi.py'
        }
    },
    'stage': {
        'server': 'root@cmbhosting.no-ip.biz',
        'django': {
            'site_name': 'cambieri-cambieri_it',
            'site_dir_name': 'cambieri-cambieri_it-stage',
            'site_root': '/opt/django/sites/cambieri-cambieri_it-stage/',
            'project_dir_name': 'cambieri_it',
            'project_root': '/opt/django/sites/cambieri-cambieri_it-stage/cambieri_it/',
            'settings_module': 'cambieri_it.settings.stage'
        },
        'virtualenv': {
            'path': '/opt/django/virtualenvs/cambieri-cambieri_it-stage/',
            'requirements_file': '/opt/django/sites/cambieri-cambieri_it-stage/requirements/requirements_live.txt',
        },
        'git': {
            'server_name': 'origin',
            'branch_name': 'stage',
        ...
        'webserver': {
            'touch_file': '/opt/django/sites/cambieri-cambieri_it-stage/uwsgi/stage/django_wsgi.py'
        }
    }
}
...
def prepare_git():
    with lcd('/home/workspace-django/projects/cambieri-cambieri_it'):
        git_create_repo_param = '{"name":"cambieri-cambieri_it"}'
        ...
        local('git remote add origin git@github.com:cambieri/cambieri-cambieri_it.git')
